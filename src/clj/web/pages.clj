   ...
   (html-response
     ...
     (hiccup/html5
       [:head
        ...
        [:meta {:property "og:url" :content (:url og "https://hubteki.net")}]
        ;[:meta {:property "og:image" :content (:image og "https://www.hubteki.net/img/icons/hubteki_167.png")}]
        [:meta {:property "og:title" :content (:title og "Play Hubworld: Aidalon in your browser")}]
        [:meta {:property "og:site_name" :content (:site_name og "hubteki.net")}]
        ...
        ;[:link {:rel "apple-touch-icon" :href "/img/icons/hubteki_167.png"}]
        [:title "Hubteki"]
